...
const unhostGame = () => __awaiter(void 0, void 0, void 0, function* () {
    const marks = yield (0, requestToGuiServer_1.sendCommand)("unhost");
    if (!marks)
        return null;
    const commandResult = yield (0, requestToGuiServer_1.whaitForCommandResult)({
        startMark: marks[0],
        endMark: marks[1],
        successMark: globals_1.ghostCommandsMarks.unhost.success,
    });
    return commandResult;
});
exports.unhostGame = unhostGame;
