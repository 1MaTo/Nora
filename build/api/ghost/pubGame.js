...
const pubGame = (gamename) => __awaiter(void 0, void 0, void 0, function* () {
    const marks = yield (0, requestToGuiServer_1.sendCommand)(`pub ${gamename ? gamename : ""}`);
    if (!marks)
        return null;
    const commandResult = yield (0, requestToGuiServer_1.whaitForCommandResult)({
        startMark: marks[0],
        endMark: marks[1],
        successMark: globals_1.ghostCommandsMarks.pub.success,
    });
    return commandResult;
});
exports.pubGame = pubGame;
