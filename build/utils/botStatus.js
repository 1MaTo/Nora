...
const changeBotStatus = (message) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!globals_1.production)
            return;
        yield bot_1.client.user.setActivity(message);
        return;
    }
    catch (error) {
        log_1.log(error);
...
const updateStatusInfo = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!globals_1.botStatusVariables.ghost)
        return yield exports.changeBotStatus(`${ghost}`);
    const lobby = globals_1.botStatusVariables.lobbyCount
        ? ` | Lobby: ${globals_1.numberToEmoji(globals_1.botStatusVariables.lobbyCount)}`
        : "";
    const games = globals_1.botStatusVariables.gameCount
        ? ` | Games: ${globals_1.numberToEmoji(globals_1.botStatusVariables.gameCount)}`
        : "";
    yield exports.changeBotStatus(`${ghost}${lobby}${games}`);
});
