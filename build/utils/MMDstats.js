...
const getParsedGamesStats = (nickname = null) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let gameIds = null;
    if (nickname) {
        gameIds = yield queries_1.getGamesIdByPlayerNickname(nickname);
    }
    else {
        gameIds = yield queries_1.getFinishedGamesId();
    }
    if (!gameIds || gameIds.length === 0)
        return null;
    const groupedGames = yield queries_1.getGroupedGamesByGameid(gameIds);
    for (let index = 0; index < groupedGames.length; index++) {
        ...
        const teamMMDstats = yield queries_1.getPlayersMMDStats(team.gameid, team.colours);
        if (!currGame) {
...
const getWinStats = (nickname) => __awaiter(void 0, void 0, void 0, function* () {
    const games = yield exports.getParsedGamesStats(nickname);
    if (!games)
        return null;
...
const getLeaderBordByDamage = (threshold = 3) => __awaiter(void 0, void 0, void 0, function* () {
    const games = yield exports.getParsedGamesStats();
    if (!games)
        return null;
