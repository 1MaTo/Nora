...
exports.getCurrentLobbies = exports.getFullLobbyInfo = exports.playersLobbyToString = exports.getPlayersTableFromRawString = exports.parseMapName = exports.SPACE = exports.USER_LOBBY_PREFIX = exports.EMPTY_LOBBY_WINRATE = exports.EMPTY_LOBBY_DEFAULT = exports.EMPTY_LOBBY_USER_NAME = void 0;
...
const getPlayersTableFromRawString = (rawString, totalSlots, slotMap, rankMap, mapName) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const playersArray = yield Promise.all([...Array(totalSlots).keys()].map(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const winrate = rankMap && name
            ? yield queries_1.getPlayerWinrateForLobbyWatcher(name)
            : exports.EMPTY_LOBBY_DEFAULT;
        return {
    ...
    const lobby = playersArray.map((player) => {
        ...
        const ping = player.ping === exports.EMPTY_LOBBY_DEFAULT
            ...
            : player.ping + "ms";
        //  Change username
        const name = player.name === exports.EMPTY_LOBBY_DEFAULT
            ? exports.EMPTY_LOBBY_USER_NAME
            : player.name;
...
const getFullLobbyInfo = (guildID, game) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const mapName = exports.parseMapName(game.map);
    const defaultConfig = {
        name: mapName,
        guildID: guildID,
        options: {
    ...
    const config = (yield mapConfig_1.searchMapConfigByMapName(mapName, guildID)) || defaultConfig;
    const lobbyTable = yield exports.getPlayersTableFromRawString(game.usernames, config.slots, config.slotMap, config.options.ranking, config.name);
    return {
        botid: game.botid,
...
const getCurrentLobbies = (guildID) => __awaiter(void 0, void 0, void 0, function* () {
    const rawGames = yield queries_1.getLobbyList();
    if (!rawGames)
        return null;
    const lobbies = (yield Promise.all(rawGames.map((game) => __awaiter(void 0, void 0, void 0, function* () { return exports.getFullLobbyInfo(guildID, game); })))).filter((lobby) => lobby !== null);
    return lobbies;
});
