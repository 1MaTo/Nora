...
const start_1 = require("../api/commands/lobby/start");
const stop_1 = require("../api/commands/lobby/stop");
const lobby_1 = __importDefault(require("../commandData/lobby"));
const globals_1 = require("../utils/globals");
module.exports = {
    data: lobby_1.default,
    execute(interaction) {
